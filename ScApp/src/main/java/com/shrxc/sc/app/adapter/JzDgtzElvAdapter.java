...
public class JzDgtzElvAdapter extends BaseExpandableListAdapter {
    ...
    public JzDgtzElvAdapter(Context context, List<JzGroupGameEntity> games) {
    ...
    public View getChildView(final int gPos, final int cPos, boolean b, View view, ViewGroup viewGroup) {
            ...
            if (key < 7) {
                if (key == 0) {
                    ...
                    JzAdapterUtil.initViewState(context, childs.get(gPos).get(cPos).get(key),
                            (LinearLayout) cvh.selectLayout.getChildAt(key - 1), key - 1, 1);
                }
            }
        }
        ...
        ((TextView) cvh.sLayout.getChildAt(1)).setText(games.get(gPos).getGames().get(cPos).getSpl());
        ...
        cvh.fxLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                JzAdapterUtil.changeViewSet(context, JzDgtzElvAdapter.this, gPos, cPos, 0, childs, null);
            }
        });
        /**
         * 非让球-胜
        ...
        cvh.sLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JzAdapterUtil.changeViewSet(context, JzDgtzElvAdapter.this, gPos, cPos, 1, childs, games);
            }
        });
        /**
         * 非让球-平
        ...
        cvh.pLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JzAdapterUtil.changeViewSet(context, JzDgtzElvAdapter.this, gPos, cPos, 2, childs, games);
            }
        });
        /**
         * 非让球-负
    ...
    private void showQbxxDialog(final int gPos, final int cPos, JzTzTypeEntity entity) {
        ...
        final TextView rqTextView = view.findViewById(R.id.jz_dgtz_elv_qbxx_dialog_rq_text);
    ...
    private class ChildViewHolder {
        ...
        public ChildViewHolder(View view) {
            ...
            rqLayout = view.findViewById(R.id.jz_dgtz_elv_child_rq_layout);
            xqTextView = view.findViewById(R.id.jz_dgtz_elv_child_xq_text);
            typeTextView = view.findViewById(R.id.jz_dgtz_elv_child_type_text);
            jzrqTextView = view.findViewById(R.id.jz_dgtz_elv_child_jzrq_text);
            rqTextView = view.findViewById(R.id.jz_dgtz_elv_child_rq_text);
