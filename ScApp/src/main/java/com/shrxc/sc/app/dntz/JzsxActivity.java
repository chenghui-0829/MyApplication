...
public class JzsxActivity extends AppCompatActivity {
    ...
    private Context context = JzsxActivity.this;
    @BindView(R.id.jzsx_activity_all_text)
    TextView allTextView;
    @BindView(R.id.jzsx_activity_fx_text)
    TextView fxTextView;
    @BindView(R.id.jzsx_activity_ls_text)
    TextView lsTextView;
    @BindView(R.id.jzsx_activity_back_icon)
    ImageView ackIcon;
    @BindView(R.id.jz_activity_ss_grid)
    GridView gridView;
    private List<String> ssTypeList;
    private int selected = 0;
    private Map<Integer, Integer> stateMap;
    private GridAdapter adapter;
    private String ls[] = {"英超", "意甲", "德甲", "西甲", "法甲"};
    ...
    private void initData() {
        ...
        stateMap = JczqActivity.stateMap;
        ...
        switch (view.getId()) {
            case R.id.jzsx_activity_all_text:
                if (selected != 0) {
                    ...
                    lsTextView.setTextColor(getResources().getColor(R.color.app_text_color_333333));
                    lsTextView.setBackgroundResource(R.color.app_transparent_color);
                    selected = 0;
                }
                ...
                break;
            case R.id.jzsx_activity_fx_text:
                if (selected != 1) {
                ...
                adapter.notifyDataSetChanged();
                break;
            case R.id.jzsx_activity_ls_text:
                if (selected != 2) {
                    lsTextView.setTextColor(getResources().getColor(R.color.app_white_color_ffffff));
                    lsTextView.setBackgroundResource(R.drawable.right_red_circle_bg);
                    allTextView.setTextColor(getResources().getColor(R.color.app_text_color_333333));
                    allTextView.setBackgroundResource(R.color.app_transparent_color);
                    fxTextView.setTextColor(getResources().getColor(R.color.app_text_color_333333));
                    fxTextView.setBackgroundResource(R.color.app_transparent_color);
