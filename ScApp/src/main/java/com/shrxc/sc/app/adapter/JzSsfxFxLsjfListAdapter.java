...
public class JzSsfxFxLsjfListAdapter extends BaseAdapter {

    private Context mContext;
    private int count = 0;
    private List<JzssfxZjEntity> list;

    public JzSsfxFxLsjfListAdapter(Context context, List<JzssfxZjEntity> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ViewHolder vh = null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.jz_ssfx_fx_lsjf_list_adapter_layout, viewGroup, false);
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            ssNameTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_ssname_text);
            timeTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_time_text);
            zdNameTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_zdname_text);
            kdNameTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_kdname_text);
            bfTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_bf_text);
            resultTextView = view.findViewById(R.id.jz_ssfx_fx_lsjf_list_result_text);
        }
    }
